...
{
	spi_peri_write(&SPI_MASTER_0,Data&0xFF);
}
...
{
	spi_peri_write(&SPI_MASTER_0,Data|0x100);
}
...
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
unsigned char Shift = 0x1c; // Positionierung da nicht auf der Kante
...
{
unsigned char Max_Column = 0x3F;
unsigned char Max_Row = 0x3F;
